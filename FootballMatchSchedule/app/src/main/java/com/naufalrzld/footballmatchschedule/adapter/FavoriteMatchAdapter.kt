...
import com.naufalrzld.footballmatchschedule.model.Favorite
...
class FavoriteMatchAdapter(private val context: Context, private val events: List<Favorite>,
    ...
    override fun onBindViewHolder(holder: FavoriteMatchAdapter.ViewHolder, position: Int) {
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(event: Favorite, listener: (Favorite) -> Unit) {
